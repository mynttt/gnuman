...
public class Dialogs {
    ...
    public static void exceptionDialog(Exception e, String title, String notification) {
        ...
        alert.setGraphic(new ImageView(Dialogs.class.getResource("/editor/error.png").toExternalForm()));
    ...
    public static void dialog(AlertType type, String header, String notification) {
        ...
        switch(type) {
            case INFORMATION:
                alert.setGraphic(new ImageView(Dialogs.class.getResource(header.equals("__HackForDialog") ? "/editor/editor.png" : "/editor/info.png").toExternalForm()));
            ...
            case ERROR:
                ...
                break;
            case WARNING:
                alert.setGraphic(new ImageView(Dialogs.class.getResource("/editor/warning.png").toExternalForm()));
                break;
            default: break;
        }
    ...
    public static boolean yesOrNoDialog(String header, String notification) {
        ...
        alert.setGraphic(new ImageView(Dialogs.class.getResource("/editor/question.png").toExternalForm()));
    ...
    static void help() {
        ...
        p.setCenter(v);
        v.getEngine().load(Helper.class.getResource("/editor/html/index.html").toExternalForm());
    ...
    static void aStarDialog(String title, String notification, String trace) {
        ...
        alert.setGraphic(new ImageView(Dialogs.class.getResource("/editor/info.png").toExternalForm()));
    ...
    static void showCredits() {
        Alert alert = new Alert(AlertType.INFORMATION);
        alert.setGraphic(new ImageView(Dialogs.class.getResource("/editor/creative-commons-logo.png").toExternalForm()));
