...
public class Textures {
    ...
    public static EntityAnimation createEntityAnimation(int fpsCap, int spriteWidth, int spriteHeight) throws Exception {
        ...
        java.awt.Image sheet = ImageIO.read(path("game/" + (Constants.TEXTURE_USE_CLASSIC_SPRITES_FOR_GHOSTS ? Constants.TEXTURE_GHOST_SPRITES_CLASSIC : Constants.TEXTURE_GHOST_SPRITES_CORPORATIONS)));
    ...
    //Player
        sheet = ImageIO.read(path("game/rms.png"));
    ...
    private static InputStream path(String s) {
        return Textures.class.getResourceAsStream(Constants.TEXTURE_PATH_PREFIX + s);
    }
