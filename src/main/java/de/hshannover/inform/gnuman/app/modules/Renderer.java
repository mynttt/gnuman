...
public class Renderer {
    ...
    public Renderer(GraphicsContext gc, Textures textures, DynamicVariables dyn, boolean dynamicCamera, Player player) {
        ...
        gameFont = Font.loadFont(getClass().getResourceAsStream("/css/fonts/game.ttf"), dyn.getUiFontSize());
        mediumFont = Font.loadFont(getClass().getResourceAsStream("/css/fonts/game.ttf"), dyn.getUiFontSize()*1.25);
        largeFont = Font.loadFont(getClass().getResourceAsStream("/css/fonts/game.ttf"), dyn.getUiFontSize()*1.5);
        smallFont = Font.loadFont(getClass().getResourceAsStream("/css/fonts/game.ttf"), dyn.getUiFontSize()*0.5);
